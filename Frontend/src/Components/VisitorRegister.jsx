        ...
        <>
            <div className='relative min-h-screen bg-black overflow-hidden flex items-center justify-center'>
                ...
                <form onSubmit={handleSubmit} className='relative z-10 w-[320px] sm:w-[420px] items-center rounded-2xl p-8 border-t-5 border-t-purple-900 flex flex-col bg-white/5 border-white/10 border-2 shadow-[-0_25px_60px_rgba(0,0,0,0.85)] gap-5 backdrop-blur-2xl'>
                    ...
                    <h1 className='text-center text-2xl font-bold bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent'>Welcome</h1>
                    ...
                    <p className='text-sm text-gray-400 font-bold'>Aleready a visitor?  <span className='text-purple-600 font-semibold hover:underline'><Link to="/visitor-login">click here</Link></span> </p>
